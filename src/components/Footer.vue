  ...
  <footer>
    <div class="py-4 border-t-2 max-h-full border-black dark:bg-gray-700 text-center">
      <div class="flex justify-center space-x-5 rtl:space-x-reverse">
        ...
        <a href="https://twitter.com/Tofu_maulana" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
        ...
        <a href="https://www.instagram.com/tofumaulana/" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
        ...
        <a href="https://github.com/tofumaulana" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
